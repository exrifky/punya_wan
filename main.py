...
if option == 'Home' or option == '':
    ...
    if st.button('Paste Data'):
        ...
        df1.replace(to_replace="Teknologi Media Game dan Piranti Bergerak", value="1", inplace=True)
        df1.replace(to_replace="Jaringan Berbasis Informasi", value="2", inplace=True)
        df1.replace(to_replace="Rakayasa Perangkat Lunak", value="3", inplace=True)
        df1.replace(to_replace="Sistem Cerdas / Computer vision", value="4", inplace=True)
        ...
        row_prediksi = pd.concat([df1[['Nama Lengkap']], df_prediksi], axis=1)
